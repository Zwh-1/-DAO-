...
export default function ArbitratorCasesPage() {
    ...
    <RoleGuard required="arbitrator">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 p-4">
        <section className="card">
          <h1 className="text-2xl font-bold text-primary">案件列表</h1>
          <p className="mt-2 section-desc">
            以下数据来自后端为当前钱包地址分配的仲裁任务。从列表可跳转到投票页并预填提案 ID。
          </p>
          <div className="mt-4 flex flex-wrap gap-4 text-sm">
            <Link href="/arbitrator" className="font-semibold text-primary underline">
              返回仲裁工作台
            </Link>
