...
import { sanitizeRoles } from "@/lib/roleUtils";
import { walletConnectorLabel } from "@/lib/wallet/walletLabels";
import { navItems, type NavItem } from "./NavItems";

const ConnectWalletModal = dynamic(
  () => import("../wallet/ConnectWalletModal").then((m) => m.ConnectWalletModal),
  { ssr: false }
);
        ...
        {dropdownOpen && (
          <div className="absolute right-0 top-full mt-1.5 w-64 rounded-xl border border-gray-100/60 bg-white shadow-lg z-50">
            ...
            <div className="px-4 py-3 border-b border-gray-100/60">
              ...
              {roleHint && <p className="text-[11px] text-alert mb-1.5">{roleHint}</p>}
