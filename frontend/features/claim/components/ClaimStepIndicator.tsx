          ...
          return (
            ...
            >
              <span
                ...
                style={{
                  background: done ? DONE : current ? PRIMARY : '#E2E8F0',
              ...
              <span
                ...
                style={{ color: current ? PRIMARY : '#64748B' }}
              >
                {s.label}
              </span>
              {i < STEPS.length - 1 && (
                <span className="hidden sm:inline flex-1 border-t border-dashed mx-1 min-w-[8px]" style={{ borderColor: '#CBD5E1' }} />
              )}
            </li>
          );
        })}
