    ...
    <>
      ...
      >
        ...
        <div className="p-4 bg-gray-50 border-b border-gray-100">
          ...
          <div className="font-mono text-sm font-bold truncate" style={{ color: COLORS.primary }}>
          ...
          <div className="py-2 border-b border-gray-100">
            ...
            {Object.entries(NETWORK_CONFIG).map(([id, config]) => {
              ...
              return (
                ...
                >
                  <span className="font-bold" style={{ color: isActive ? config.color : COLORS.primary }}>
                    {config.name}
                  </span>
