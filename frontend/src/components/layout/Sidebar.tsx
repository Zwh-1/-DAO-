...
const NavGroup = memo(function NavGroup({ 
    ...
    return (
        <div className="mt-3 mb-1">
            <button
                onClick={toggle}
                className="w-full flex items-center justify-between px-4 py-1.5 text-xs font-semibold text-steel/60 uppercase tracking-wider hover:text-primary/70 transition-colors rounded-lg hover:bg-surface"
            ...
            <AnimatePresence initial={false}>
                {isOpen && (
                    ...
                    >
                        <div className="space-y-0.5 relative pt-0.5">
                            {children}
                        </div>
                    </motion.div>
                )}
